...
* **2 petites voitures à 650 $CAD chaque (unlimited miles)** = **$1 300 total pour le groupe sur 14 jours**. Modèle type : **Ford Fiesta, VW Polo, Vauxhall Corsa, Hyundai i20** — 5 places (+ coffre limité), boîte manuelle, essence.
* **Capacité** : 2 × 5 places = 10 places ; 7 pax + équipement camping ⇒ **3-4 personnes par voiture + sacs/tentes répartis**. Le coffre d'une compacte UK = ~290 L = serré. **Critique** : optimiser le packing (drysacs compressibles plutôt que valises rigides, partager tentes 4 places × 2).
* **Loueurs** : Discover Cars / Rentalcars / Arnold Clark / Europcar Edinburgh Airport. Avec **frais récup 25 ans+ chauffeur principal** + **conducteur additionnel** ajouté pour partager (souvent gratuit ou £5/jour).
* **Boîte manuelle obligatoire** : confirmer 2 chauffeurs UK-manual compétents AVANT le booking.
* **A/R même endroit (Edinburgh Airport)** = **pas de frais one-way** (économie ~£300/véh vs one-way Highland → south).

**Estimation essence (carburant) :**

* **Distance totale estimée** : ~2 050 km (Edinburgh → Stirling → Glencoe → Skye → Torridon → Assynt → Sandwood Bay → Cairngorms → Dunnottar → Edinburgh).
* **Consommation petites voitures** : ~6 L/100 km en mixed driving Highlands (single-track, montées, vitesse modérée).
* **Total carburant** : 2 050 km × 2 voitures × 6 L/100 km = **246 L total**.
* **Prix essence UK juillet 2026** (estimation) : **£1,50-1,65/L** (≈ $2,58-2,84 CAD/L, taux 1 GBP = 1,72 CAD).
  - **MIN** £1,45/L : 246 × 1,45 = £357 = **~$613 CAD**.
  - **RÉAL** £1,55/L : 246 × 1,55 = £381 = **~$655 CAD**.
  - **PESSIM** £1,85/L (volatilité Brent + FIFA WC indirect) : 246 × 1,85 = £455 = **~$783 CAD**.
* **Notes** : single-track Highlands consomme un peu plus (montées + relances), mais petites voitures = très efficaces. Plein quotidien recommandé Highlands (stations rares — penser **Tyndrum, Fort William, Portree, Ullapool, Lochinver, Durness, Aviemore**).

## ---

**🏕️ RÉSERVATIONS À VERROUILLER TÔT**

**Wild camping = pas de réservation requise** — le Land Reform Act 2003 garantit l'accès. **Pas de trek backcountry verrouillé** dans cette version (vs trek Skye Trail dans plan précédent) — le voyage devient une **expédition de wild camping itinérant** sur les spots les plus dramatiques. Plus flexible, plus immersif.
...
**🛣️ TEMPS DE CONDUITE RÉELS (Google Maps + locaux, sans trafic)**

Référence pour planifier les départs. **Single-track Highlands** = vitesse limitée par passing places + moutons + caravanes touristiques. Ajouter **20-30 % tampon** sur tout segment Highland.

| Trajet | Conduite pure | Distance |
|---|---|---|
| EDI Airport → Edinburgh centre | 25 min | 13 km |
| EDI → Stirling | 1 h 00 | 70 km |
| Stirling → Glencoe (Glen Etive) | 2 h 30 | 175 km |
| Glencoe → Glen Etive (single-track entrée) | 30 min (aller seul) | 25 km |
| Glencoe → Glenfinnan | 1 h 15 | 80 km |
| Glenfinnan → Mallaig (ferry CalMac) | 1 h 00 | 70 km |
| Mallaig ↔ Armadale (ferry CalMac, 30 min) | — | 8 km nautiques |
| Glenfinnan → Castle Tioram (Acharacle) | 1 h 30 | 75 km |
| Mallaig → Skye Bridge → Portree | 2 h 45 | 175 km |
| Portree → Old Man of Storr trailhead | 15 min | 12 km |
| Portree → Quiraing trailhead | 30 min | 30 km |
| Portree → Fairy Pools (Glen Brittle) | 1 h 00 | 50 km (single-track) |
| Portree → Neist Point | 1 h 15 | 65 km (single-track) |
| Skye (Sligachan) → Eilean Donan (via Skye Bridge) | 1 h 30 | 110 km |
| Eilean Donan → Torridon (village) | 1 h 30 | 95 km |
| Torridon → Ullapool | 2 h 15 | 150 km |
| Ullapool → Lochinver (Assynt) | 50 min | 60 km |
| Lochinver → Stac Pollaidh trailhead | 30 min | 25 km |
| Lochinver → Achmelvich Beach | 15 min | 10 km |
| Lochinver → Sandwood Bay parking (Blairmore) | 2 h 00 | 105 km (single-track) |
| Sandwood Bay parking → plage (HIKE) | 1 h 30 marche | 7 km AR sentier |
| Blairmore (Cape Wrath area) → Lairg | 2 h 00 | 130 km |
| Lairg → Aviemore (Cairngorms) | 2 h 00 | 165 km |
| Aviemore → Pitlochry | 1 h 15 | 95 km |
| Aviemore → Stonehaven (Dunnottar Castle) | 2 h 30 | 175 km |
| Stonehaven → Edinburgh | 2 h 00 | 145 km |
| Edinburgh ↔ EDI Airport | 25 min | 13 km |

**À éviter :**
- **Glencoe → Skye + visite Old Man of Storr en 1 jour** (8 h+ tout cumul) — couper avec wild camp Glenfinnan ou ferry Mallaig.
- **Skye → Sandwood Bay direct** (~6 h via Ullapool) — couper avec wild camp Torridon ou Assynt.
- **NC500 complète** (516 mi / 830 km) — trop long pour 14 jours, on prend la **section ouest dramatique** (Torridon → Assynt → Cape Wrath).

## ---

**🫁 CADENCE — Wild camping cinématique progressif → finale Edinburgh**

Le voyage est conçu comme une **progression géographique vers les paysages les plus extrêmes** : du Loch Lomond accessible jusqu'au Cape Wrath sauvage (le bout du monde britannique), puis **descente vers Edinburgh civilisée** pour la décompression urbaine et culturelle.
...
**⛰️ SENTIERS RECOMMANDÉS — LES PLUS DRAMATIQUES + LIENS ALLTRAILS**

**Philosophie** : on cherche **la dramaticité maximale par rando**, pas la quantité. Chaque sentier choisi = **paysage cinématique unique** qu'on ne voit pas ailleurs au monde. ⭐⭐⭐ = perle absolue (vue + ambiance + ratio effort/récompense imbattable, **trip-of-a-lifetime tier**).

### 🏔️ Glencoe — Jour 3 (la zone la plus cinématique du Royaume-Uni)

| Sentier | km | D+ | Note | Diff. | Pourquoi | Lien |
|---|---|---|---|---|---|---|
| **🏆 Buachaille Etive Mòr / Stob Dearg** ⭐⭐⭐ | 8.0 | 850 m | 4.8★ | Hard | **LA Munro signature de Glencoe.** Pyramide noire iconique des photos Scotland. Voie normale Coire na Tulaich (pas de scrambling exposé). ~5-6 h. **Vue sommet 360° sur Rannoch Moor + Glen Etive + Glencoe.** | [AllTrails](https://www.alltrails.com/trail/scotland/highland/buachaille-etive-mor-stob-dearg-via-coire-na-tulaich) |
| **🏆 Lost Valley (Coire Gabhail)** ⭐⭐⭐ | 4.5 | 280 m | 4.7★ | Mod | **Vallée cachée des MacDonald**, où ils planquaient le bétail volé. Court, magique, ambiance Tolkien. **Plan-B parfait** si météo défavorable pour Buachaille. | [AllTrails](https://www.alltrails.com/trail/scotland/highland/coire-gabhail-the-lost-valley-from-glen-coe) |
| **Pap of Glencoe** ⭐⭐ | 6.5 | 740 m | 4.7★ | Hard | Sommet conique au-dessus de Glencoe village, vue Loch Leven + Glencoe. Plus court que Buachaille. | [AllTrails](https://www.alltrails.com/trail/scotland/highland/sgorr-na-ciche-pap-of-glencoe) |
| **🏆 Glen Etive single-track drive** ⭐⭐⭐ | route | 0 m | 4.9★ | Easy | **Skyfall (James Bond) location**. Single-track 24 km dans la vallée la plus cinématique d'Écosse. Wild camp en bord de rivière River Etive. **Pas une rando — c'est l'environnement de la nuit J2.** | — |

### 🏔️ Isle of Skye — Jours 5-6 (paysages les plus dépaysants)

| Sentier | km | D+ | Note | Diff. | Pourquoi | Lien |
|---|---|---|---|---|---|---|
| **🏆 Old Man of Storr Loop** ⭐⭐⭐ | 4.0 | 320 m | 4.8★ | Mod | **THE iconic Skye hike**. Pinacles rocheux dramatiques, vue Sound of Raasay. ⚠️ Foule — partir AVANT 7h00 ou APRÈS 17h00. | [AllTrails](https://www.alltrails.com/trail/scotland/highland/the-storr) |
| **🏆 Quiraing Loop** ⭐⭐⭐ | 6.7 | 380 m | 4.8★ | Mod | **Paysage le plus surréaliste de Skye** — pinacles, vallées cachées, ambiance lunaire. Plus tranquille que Storr. **Boucle complète recommandée**. | [AllTrails](https://www.alltrails.com/trail/scotland/highland/the-quiraing-loop) |
| **🏆 Fairy Pools** ⭐⭐⭐ | 4.0 | 130 m | 4.7★ | Easy | Bassins turquoise + cascades + fond des Cuillins en arrière-plan. Baignade **glacée** (8-10 °C) pour les courageux. ⚠️ Foule — partir 7h00 ou 18h00. | [AllTrails](https://www.alltrails.com/trail/scotland/highland/fairy-pools-from-glen-brittle) |
| **🏆 Neist Point Lighthouse** ⭐⭐⭐ | 3.0 | 100 m | 4.7★ | Easy | Phare au point le plus à l'ouest de Skye, falaises basaltiques, **coucher du soleil iconique** (~21h25). **Wild camp possible parking + clifftop**. | [AllTrails](https://www.alltrails.com/trail/scotland/highland/neist-point-lighthouse-trail) |
| **Coral Beaches (Claigan)** ⭐⭐ | 3.5 | 50 m | 4.6★ | Easy | Plage de sable corail blanc rare, eau turquoise sur fond de Cuillins. En route Dunvegan. | [AllTrails](https://www.alltrails.com/trail/scotland/highland/claigan-coral-beach) |
| **Bla Bheinn (Blaven)** ⭐⭐ | 8.5 | 950 m | 4.7★ | Hard | Munro isolé des Cuillins, alternative big-day si forme + météo. Vue 360° Cuillin Ridge. | [AllTrails](https://www.alltrails.com/trail/scotland/highland/bla-bheinn-blaven) |

### 🏔️ Torridon — Jour 7 (les "Munros sandstone" les plus dramatiques)

**Pourquoi Torridon** : massifs de **grès rouge Torridonien** (1,2 milliard d'années — plus vieux que les Cuillins de Skye), formes géologiques sculptées par les glaciers en lames et tours. **Beinn Eighe + Liathach + Beinn Alligin** = la Trinity de Torridon — **les Munros les plus dramatiques du Royaume-Uni** selon les locaux.

| Sentier | km | D+ | Note | Diff. | Pourquoi | Lien |
|---|---|---|---|---|---|---|
| **🏆 Beinn Alligin Horseshoe** ⭐⭐⭐ | 11.0 | 1 100 m | 4.9★ | Hard | **Crête courbe avec 2 sommets (Tom na Gruagaich + Sgurr Mhor)** + tour distinctive **Black Cleft**. Vue océan + Loch Torridon. Le Munro Torridon le plus accessible (vs Liathach scrambling exposé). | [AllTrails](https://www.alltrails.com/trail/scotland/highland/beinn-alligin) |
| **🏆 Beinn Eighe — Coire Mhic Fhearchair Loop** ⭐⭐⭐ | 16.0 | 700 m | 4.9★ | Mod-Hard | **LE coire le plus spectaculaire d'Écosse** : 3 montagnes en arc autour d'un loch turquoise, "Triple Buttress" de quartzite blanche au-dessus du grès rouge. **Pas de sommet bagging requis** — on monte juste au coire. | [AllTrails](https://www.alltrails.com/trail/scotland/highland/coire-mhic-fhearchair) |
| **Liathach (Spidean a' Choire Lèith)** ⭐⭐⭐ | 12.0 | 1 250 m | 4.9★ | Very Hard | **Le Munro le plus exposé du UK** — crête en lames, scrambling Grade 2-3 obligatoire. **Pour expérimentés uniquement**. Si forme + temps clair = expérience d'une vie. | [AllTrails](https://www.alltrails.com/trail/scotland/highland/liathach) |
| **Diabaig Coastal Path** ⭐⭐ | 6.0 | 200 m | 4.6★ | Mod | Sentier côtier de Torridon village vers Diabaig hameau de pêcheurs. Vue Loch Torridon + Skye au loin. | [AllTrails](https://www.alltrails.com/trail/scotland/highland/diabaig-coastal-path) |

**Pick** : **Beinn Alligin Horseshoe** = best ratio dramatique/effort. **Beinn Eighe Coire** si météo douteuse (moins exposé).

### 🏔️ Assynt / Coigach — Jour 8 (les "petites montagnes les plus distinctives" du UK)

**Pourquoi Assynt** : massif de **gneiss Lewisien** (3 milliards d'années — la plus vieille roche du Royaume-Uni), avec des **montagnes isolées qui surgissent du terrain plat** comme des îles. **Stac Pollaidh, Suilven, Quinag, Cul Mor** — chaque montagne est une silhouette distinctive iconique.

| Sentier | km | D+ | Note | Diff. | Pourquoi | Lien |
|---|---|---|---|---|---|---|
| **🏆 Stac Pollaidh Loop** ⭐⭐⭐ | 4.5 | 600 m | 4.9★ | Mod | **La rando Highlands la plus payante en effort/récompense.** Petite montagne (612 m) mais avec **crête de pinacles spectaculaire** et **vue 360° sur Assynt + Inverpolly + Atlantique**. Court (~3 h). | [AllTrails](https://www.alltrails.com/trail/scotland/highland/stac-pollaidh) |
| **Suilven** ⭐⭐⭐ | 22.0 | 750 m | 4.9★ | Hard | **THE most distinctive mountain shape in UK** — pyramide isolée surgissant des Hautes Terres. Approche longue (8 km plat) + montée raide. Journée complète 10 h. **Une vie**. | [AllTrails](https://www.alltrails.com/trail/scotland/highland/suilven) |
| **Quinag (Sail Gharbh)** ⭐⭐ | 11.0 | 800 m | 4.7★ | Hard | 3 sommets en cèche, vue Eddrachillis Bay + Sutherland. Plus accessible que Suilven. | [AllTrails](https://www.alltrails.com/trail/scotland/highland/quinag-sail-gharbh) |
| **Achmelvich Beach Loop** ⭐⭐ | 3.0 | 80 m | 4.7★ | Easy | **Plage de sable blanc + eau turquoise des Caraïbes en Écosse**. Wild camp possible. | [AllTrails](https://www.alltrails.com/trail/scotland/highland/achmelvich-coastal-walk) |

**Pick** : **Stac Pollaidh** (court, payant, accessible). Suilven = option si volonté big-day.

### 🏖️ Sandwood Bay (Cape Wrath area) — Jour 9 (le bout du monde britannique)

**Pourquoi Sandwood Bay** : **plage la plus reculée du Royaume-Uni** — 7 km AR à pied depuis le parking Blairmore, **aucune route ne mène à la plage**. Sable rose-doré + falaises grès + arche **Am Buachaille** (sea stack 65 m) + dunes immenses + **ZERO civilisation visible**. **Wild camping légal** sur la plage (au-dessus ligne marée haute). **L'expérience la plus dépaysante du voyage.**

| Sentier | km | D+ | Note | Diff. | Pourquoi | Lien |
|---|---|---|---|---|---|---|
| **🏆 Sandwood Bay Trail** ⭐⭐⭐ | 7.0 (AR) | 100 m | 4.9★ | Easy-Mod | Sentier plat à travers tourbières + landes vers la plage la plus isolée du UK. **Wild camp sur dunes** = expérience cinématique majeure. ⚠️ Pas d'eau potable — apporter 3 L/pax. | [AllTrails](https://www.alltrails.com/trail/scotland/highland/sandwood-bay-trail) |
| **Cape Wrath (point le plus au NW UK)** | détour | — | — | — | Phare au cap, accessible uniquement par minibus depuis Keoldale ferry (£14/pax) — **option si journée additionnelle**. Pas inclus dans plan principal. | — |
...
**🏰 CHÂTEAUX & RUINES À VISITER**

**Philosophie** : on **passe sur la route** des châteaux iconiques sans nécessairement entrer payant à chaque fois. Photo extérieure souvent suffit — entrée payante seulement pour les **2 châteaux signature**.
...
**Historic Environment Scotland Explorer Pass** ($73/pax × 7 = $511 groupe, 5 jours non-consécutifs) — couvre Stirling + Edinburgh + Urquhart + autres. **Profitable si 4+ visites payantes**. Avec notre liste (Stirling + Edinburgh = 2), **prix individuel moins cher**.

## ---

**🏘️ VILLES & VILLAGES À EXPLORER**
...
1. **The Devil's Advocate** (8 Advocate's Close, Old Town) — pub élégant dans une vieille pump house, 200+ whiskies écossais. Démarrage chic. **Pint £6**.
2. **The Last Drop** (74 Grassmarket) — pub historique au-dessus de l'ancien lieu d'exécution publique. Ambiance pub écossais classique, food OK. **Pint £5,50**.
3. **The Bow Bar** (80 West Bow) — pub authentique 30 whiskies single malt + 8 ales locales. Pas de musique, conversation pub. **Pint £5,50**.
4. **The Jolly Judge** (7A James Court) — pub caché dans une close du Royal Mile, plafond bas + cheminée. Atmosphère médiévale. **Pint £5,50**.
5. **Greyfriars Bobby's Bar** (Candlemaker Row) — pub à côté du célèbre Greyfriars Bobby (statue du chien). Touristique mais culte. **Pint £6**.
6. **Sandy Bell's** (25 Forrest Road) — **THE folk music pub of Edinburgh** depuis 1940. Live folk session quasi tous les soirs (gratuit). **Finale parfaite**. **Pint £5,50**.

**Coût estimé** : ~£35/pax pour 6 pints + snacks = $60/pax × 7 = $420 groupe.

### 🍺 Pub crawl alternatif Stockbridge (J12 soir, plus local)

**Boucle Stockbridge / New Town, ~4 pubs, 2-3 h, distance 1,5 km** :

1. **The Antiquary** (72 St Stephen St, Stockbridge) — basement pub, ales locales, ambiance bohémienne.
2. **The Bailie** (2 Saint Stephen Pl) — pub Stockbridge classique, food correct, locaux.
3. **The Cumberland Bar** (1-3 Cumberland St, New Town) — pub jardin pour l'été (rare à Edinburgh). 
4. **Dirty Dick's** (159 Rose St) — Rose Street = **historique "pub crawl street"** d'Edinburgh, 17 pubs alignés. Choisir 2-3 dans Rose Street pour finale.

### 🥃 Whisky bars à ne pas manquer

- **The Scotch Whisky Experience** (354 Castlehill, Royal Mile) — tour interactif + dégustation £20-35/pax. **OPTION** journée libre J13.
- **Whiski Rooms** (4-7 North Bank St) — restaurant + bar avec **375 whiskies** + cours de dégustation £40/pax (1 h, 4 whiskies + chocolats).
- **The Bow Bar** — déjà mentionné, le bar à whisky le plus authentique sans tourisme.
...
|---|---|---|---|
| **Rosslyn Chapel + Pentland Hills** | 30 min south | £12/pax + free hike | Da Vinci Code chapel + colline urbaine. ~5 h total. |
| **Forth Bridges + South Queensferry** | 30 min west | gratuit | 3 ponts iconiques, village pittoresque, fish & chips Hawes Inn. |
| **St Andrews + East Neuk fishing villages** | 1 h 30 NE | gratuit | Berceau du golf, ruines cathédrale, plages. |
| **North Berwick + Bass Rock seabird colony** | 45 min E | £30/pax (boat) | 150 000 fous de Bassan en mer, croisière. |
| **Glenkinchie Distillery** | 30 min SE | £18/pax tour | "The Edinburgh Malt" — distillerie Diageo accessible, tour 1 h. |
| **Linlithgow Palace** (lieu naissance Mary Queen of Scots) | 30 min W | £8/pax | Ruine palais royal, lac, court visite ~1 h. |

**Pick recommandée** : **St Andrews + East Neuk** (Crail, Anstruther, Pittenweem) — combinaison golf + plages + villages pittoresques + lunch fish & chips Anstruther (Anstruther Fish Bar, "best in UK" multiple awards).
...
* **Jour 3 (28 juil) — Glen Etive + Buachaille Etive Mòr / Lost Valley + Glencoe village :**
  ...
  - **09h00-15h00** : **🏆 Buachaille Etive Mòr / Stob Dearg** (8 km, 850 m+, 5-6 h) — la grosse Munro signature de Glencoe. Voie normale Coire na Tulaich.
    - **Plan-B météo brouillard/pluie** : **Lost Valley** (4,5 km, 280 m+, 2-3 h) — vallée cachée des MacDonald.
    - **Plan-B léger** : **Three Sisters viewpoint extended walk** + **Signal Rock loop** (3 km easy) si fatigue groupe.
  - **15h00-16h00** : retour véhicules + lunch tardif au camp ou Glencoe village.
...
* **Jour 10 (4 août) — Sandwood → NC500 → Cairngorms → Dunnottar Castle → Edinburgh :** Long drive scenic mais récompensé par 4 nuits Edinburgh.
  ...
  - **09h30-13h00** : drive Blairmore → Aviemore (Cairngorms) via **A838 + A836 + A9** (~3 h 30, on peut prendre option **Durness + Cocoa Mountain** détour 1 h pour le café-chocolat improbable au bout du monde + **Smoo Cave** 30 min visite).
  - **13h00-14h00** : lunch **Aviemore** (Mountain Café ou Cairngorm Hotel).
  - **14h00-16h00** : **Loch an Eilein Loop** (6,5 km, 50 m+, 2 h) — boucle parfaite décompression, château en ruines sur île, faune (écureuils roux possibles).
  - **16h00-18h30** : drive Aviemore → **Dunnottar Castle (Stonehaven)** (2 h 30 via A9 + A90).
...
* **Jour 12 (6 août) — Edinburgh Day 2 : Arthur's Seat + New Town + Stockbridge + pubs alternatifs :**
  ...
  - **21h00-23h30** : **🍺 PUB CRAWL ALTERNATIF Stockbridge / Rose Street** (~4 pubs, 2-3 h) :
    1. **The Antiquary** (basement Stockbridge, ales locales)
...
- **Légal partout** sauf zones bylaws Loch Lomond (zone est interdite avril-octobre dans certains périmètres). **Vérifier carte officielle** : [lochlomond-trossachs.org/things-to-do/camping](https://www.lochlomond-trossachs.org/things-to-do/camping/). On évite ces zones (notre route passe ouest Loch Lomond ou Stirling direct).
- **Règles pratiques** :
  - 4-5 m du chemin
  - Hors vue des fermes/maisons
  - 4 m d'un cours d'eau (sauf plage)
  - Groupes de 6+ : envisager plusieurs sites espacés (notre groupe = 7 = limite, OK)
- **Feux** : INTERDITS en zones tourbeuses (peat, mousse) — risque incendie. **Réchaud uniquement** dans la majorité des spots. **Sandwood Bay sable + bois flotté** = exception possible avec prudence.
- **Toilettes** : règle "cathole" (15-20 cm, 50 m d'un cours d'eau). **Wagbag pour zones très fragiles** (Sandwood, Quiraing). Apporter sacs déchets pour ramener absolument tout.
- **Bothies (Mountain Bothies Association)** : ~100 abris gratuits non-réservables FCFS. Pas inclus dans plan principal mais option si météo cataclysmique. [mountainbothies.org.uk/bothies/bothy-locations](https://www.mountainbothies.org.uk/bothies/bothy-locations/).
...
**🐜 MIDGES + MÉTÉO — préparation non négociable**
...
3. **Head nets** (£5/pax) — **7 obligatoires**. Décathlon ou Cotswold Outdoor Edinburgh.
4. **Manches longues + pantalons** pour le crépuscule (peak biting 18h-22h).
5. **Vent = sauveur** : > 7 mph wind = midges absents. **Nos spots wild camping sont presque tous venteux** (côte Skye, Sandwood Bay, Glen Etive en mouvement) — bonne couverture naturelle.

### Prévisions météo type fin juillet/début août

| Région | Pluie | Vent | Temp | Notes |
|---|---|---|---|---|
| Edinburgh / Lowlands | 30-40 % | Modéré | 12-22 °C | Plus sec que Highlands. |
| Glencoe | 60 % | Variable | 8-18 °C | Météo change toutes les 2 h. Toujours imper. |
| Skye | 50-60 % | Vent côtier | 10-18 °C | Vent = anti-midges. Fairy Pools pluvieux fréquemment. |
| Torridon / Assynt | 50 % | Modéré | 8-18 °C | Plus venté que Loch Lomond. |
| Sandwood Bay | 40 % | **Très venté** | 8-16 °C | Cape Wrath = exposé Atlantique. Tente solide obligatoire. |
| Cairngorms | 40 % | Variable | 8-18 °C | Plus sec que côte ouest. |

**App météo recommandées** : [Met Office](https://www.metoffice.gov.uk) (officielle), [Mountain Weather Information Service](https://www.mwis.org.uk) (montagne par massif), [Smidgeweb Midge Forecast](https://www.smidgeweb.co.uk/midge-forecast) (5 jours, 1-5 échelle).
...
| Poste | Détail | MIN TTL | RÉAL TTL | PESSIM TTL | RÉAL PP |
|---|---|---|---|---|---|
| **Stirling Castle** (£18/pax × 7) | Toggle ON RÉAL (recommandé > Edinburgh selon locaux) | $0 (skip) | **$216** | $216 | $31 |
| **Kilchurn Castle** | Gratuit extérieur | $0 | $0 | $0 | $0 |
...
| Poste | Détail | MIN TTL | RÉAL TTL | PESSIM TTL | RÉAL PP |
|---|---|---|---|---|---|
| **Smidge anti-midges** (3 bouteilles + recharges) | £8 × 4 = £32 | $50 | **$60** | $90 | $9 |
| **Head nets** (7 pax × £5) | Décathlon ou Cotswold Outdoor (sinon importer MTL) | $0 (importer) | **$60** | $60 | $9 |
| **Bonbonnes gaz isobutane** (10 cans pour réchauds + bcp wild camping) | £6-8/can en Cotswold/Tiso | $70 | **$90** | $120 | $13 |
| **Filtre eau / pastilles** (Aquatabs si pas déjà au sac) | Cotswold £8/pack | $20 | **$30** | $50 | $4 |
| **Cartes OS Maps / Explorer** (3 cartes Skye + Glencoe + Torridon) | OS Explorer £10/carte | $50 | **$60** | $80 | $9 |
| **OS Maps app** (£28/an, 1 abonnement partagé groupe) | Recommandé pour Sandwood Bay + Stac Pollaidh | $0 | **$48** | $48 | $7 |
| **Bois de chauffage** (Sandwood Bay seul — bois flotté plage) | Bonus, gratuit | $0 | $0 | $0 | $0 |
| **SOUS-TOTAL ÉQUIPEMENT** | | **$190** | **$348** | **$448** | **$50** |
...
| **Skip Mary King's Close** | −$240 | −$34 |
| **Skip Scotch Whisky Experience** | −$300 | −$43 |
| **Souper trip-of-a-lifetime simplifié** (Dishoom vs Witchery) | −$360 | −$51 |
| **Cuisine de groupe disciplinée** ($14/pax/j MIN vs $20 RÉAL) | −$336 | −$48 |
| **Café/snacks/pints serrés** ($5/pax/j vs $9) | −$392 | −$56 |
| **Total potentiel d'économies RÉAL → MIN** | **~$3 809** | **~$543** |
...
6. **🥃 Talisker samples libres** : visite boutique gratuite, tour formel £20/pax = $240 économisés.
7. **🏰 Eilean Donan extérieur** : photo + traversée pont = expérience identique sans £12/pax = $145 économisés.
8. **🏰 Castle Tioram + Kilchurn** : châteaux gratuits dramatiques en route — équivalents émotionnels d'Eilean Donan/Stirling sans payer.
9. **🏠 Airbnb avec parking inclus** : économie £15/jour × 2 véh × 4 nuits = $206. Filter Airbnb "free parking on premises".
10. **🍳 Cuisine groupe stricte** : 1 menu commun, 1 acheteur Tesco. Économie ~30 %.
11. **🥃 Visa Infinite LDW** : vérifier couverture 31 jours sur location UK. Économie $385.
12. **🍴 Anstruther Fish Bar** day trip J13 : £12/pax fish & chips iconique vs £30 resto Edinburgh. Économie ~$130.
...
- **Excess insurance / damage** : 1 collision single-track = excess £1 500 ($2 580). **THE risque #1** non-budgétisé.
- **Pints Edinburgh dérive** : facile de dériver à £40/pax/soir × 4 nuits = $1 950.
- **Restos premium dérive** : The Witchery ou Tom Kitchin J13 = £80/pax = $960. Plan-B Dishoom (£25/pax = $300).
...
- **Skip Stirling Castle visite** (-$216).
- **Skip Talisker Distillery tour** (-$240).
- **Skip Mary King's Close** (-$240).
- **Skip Scotch Whisky Experience** (-$300).
- **Souper Dishoom au lieu de Witchery** (-$360).
- **Total potentiel skip activités RÉAL : -$1 356 = -$194/pax**.
...
**📝 INSTRUCTIONS POUR L'IA (À lire par la prochaine IA)**
